...
const faqs = [
  ...
  },
  {
    ...
    a: "Absolutely. Our electric fences integrate with sirens, alarm panels and other security systems.",
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-blue-100 text-xl leading-9 mt-8">
              Protect homes, offices, schools, institutions and
              industrial properties with professionally installed
              electric fencing engineered for maximum security,
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10">
          ...
          <div className="bg-slate-50 rounded-3xl p-10 shadow-lg">
            ...
            <p className="text-slate-600 leading-8">
              Protect your home with modern electric fencing designed
              to discourage unauthorized entry while integrating
              seamlessly with alarm systems and CCTV surveillance.
            </p>
          ...
          <div className="bg-slate-50 rounded-3xl p-10 shadow-lg">
            ...
            <p className="text-slate-600 leading-8">
              Secure factories, schools, warehouses, offices,
              institutions and commercial facilities using heavy-duty
              perimeter security solutions built for continuous
              protection.
            </p>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="text-blue-100 mt-4">
          Reliable perimeter security that works 24 hours a day.
        </p>
      ...
      >
        ...
        <p className="text-blue-100 mt-4">
          We install trusted products from globally recognized
